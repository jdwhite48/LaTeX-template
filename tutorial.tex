...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item Concatenation: $\langconcat{A}{B} = \cset{xy}{x \in A \land y \in B}$. String concatenation can also be denoted by $x \strconcat y$.
    \end{enumerate}
    ...
    \par \abs{-1} is 1 and \nthroot{3}{27} is 3. \Pr{0=1} is 0. The set \set{1} contains only 1, and \cset{x}{x \in A} has a condition associated with it. 5 is the 6\th number in \N. This \bigcdot is a bullet. \complement{S} is the collection of elements in the "universe" set $U$ that aren't also in $S \subseteq U$.
    ...
    \par This is a directed path from $a$ to $b$: $a \pathto b$ and this is an undirected path: $a \undirpathto b$.
